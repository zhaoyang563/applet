...
Page({
  ...
  data: {
    ...
    contentArray:[
      ...
      [
        ...
        'author': 'huier',
        'price': '¥0.00',
        'desc': 'huier说太白之眼喷泉很有创新，不仅能喷水，还能喷火'
        },
        {
          'image': '../../image/index/taibai.jpeg',
          'title': '太白之眼111',
  ...
  toDetail:function(e){
    ...
    console.log(index)
    wx.navigateTo({
      url: '../indexDetail/indexDetail?index=' + index + '&dIndex=' + this.data.dIndex,
    })
    //dIndex是外层数组（导航栏那五个）的index，index是内层数组（每个导航对应下面的图片那五个）的index
  },
  /**
   * 生命周期函数--监听页面加载
   */
